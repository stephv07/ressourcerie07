...
<html>
				...
				<div class="col-md-2 col-md-offset-5 col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4">
					<form method="post" action="controller/login/controller_login.php" name="login" class="form-horizontal">
						<div class="form-group">
							...
							<div class="form-group">
									<button class="btn center-block bouton-connexion" type="submit" value="Connexion"><span class="glyphicon glyphicon-log-in"></span> Connexion</button>
							</div>
						</div>
					</form>
				</div>
	...
	<?php if(isset($_SESSION['error_login'])){ echo '<script type="text/javascript">' . 'swal("Erreur"," '. $_SESSION['error_login'] .'" , "error");' . '</script>';}?>
</html>
